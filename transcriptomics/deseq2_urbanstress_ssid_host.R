...
#read in counts
counts = read.table("../../../../raw/ssid/locatelli/allcounts_host.txt")
...
# p < 0.1
pdf(file="heatmap_treatment_p0.1.pdf", height=25, width=50)
...
# p < 0.1
pdf(file="heatmap_site_p0.1.pdf", height=24, width=48)
