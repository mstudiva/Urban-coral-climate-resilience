...
ktable=makeDeltaRanksTable(list("LC_CC"=lpv.LC_CC,"CH_CC"=lpv.CH_CC,"LH_CC"=lpv.LH_CC,"CH_LC"=lpv.CH_LC,"LH_LC"=lpv.LH_LC))
# removed LH_CH due to a standard deviation of 0 for all KOG classes
...
pdf(file="KOG_urbanstress_ofav_sym_treatment_lpv.pdf", width=7, height=8)
...
pdf(file="KOG_urbanstress_ofav_sym_treatment_corr_lpv.pdf", width=10, height=7.5)
par(mfrow=c(3,4))
...
pdf(file="KOG_urbanstress_ofav_sym_site_lpv.pdf", width=7, height=7)
...
# creating a pub-ready corr plot
pdf(file="KOG_urbanstress_ofav_sym_site_corr_lpv.pdf", width=10, height=10)
par(mfrow=c(4,4))
...
# treatment comparisons
LC_CC=load('../../../DESeq2/ofav/sym/LC_CC_fc.RData')
LC_CC # names of datasets in the package
fc.LC_CC=kog.mwu(LC_CC.fc,gene2kog) 
fc.LC_CC 

CH_CC=load('../../../DESeq2/ofav/sym/CH_CC_fc.RData')
CH_CC # names of datasets in the package
fc.CH_CC=kog.mwu(CH_CC.fc,gene2kog) 
fc.CH_CC

LH_CC=load('../../../DESeq2/ofav/sym/LH_CC_fc.RData')
LH_CC # names of datasets in the package
fc.LH_CC=kog.mwu(LH_CC.fc,gene2kog) 
fc.LH_CC 

CH_LC=load('../../../DESeq2/ofav/sym/CH_LC_fc.RData')
CH_LC # names of datasets in the package
fc.CH_LC=kog.mwu(CH_LC.fc,gene2kog) 
fc.CH_LC

LH_LC=load('../../../DESeq2/ofav/sym/LH_LC_fc.RData')
LH_LC # names of datasets in the package
fc.LH_LC=kog.mwu(LH_LC.fc,gene2kog) 
fc.LH_LC

LH_CH=load('../../../DESeq2/ofav/sym/LH_CH_fc.RData')
LH_CH # names of datasets in the package
...
# Making a heatmap with hierarchical clustering trees: 
pdf(file="KOG_urbanstress_ofav_sym_treatment_fc.pdf", width=7, height=8)
pheatmap(as.matrix(ktable),clustering_distance_cols="correlation",color=color, cellwidth=15, cellheight=15, border_color="white") 
while (!is.null(dev.list()))  dev.off()
...
# creating a pub-ready corr plot
pdf(file="KOG_urbanstress_ofav_sym_treatment_corr_fc.pdf", width=10, height=10)
par(mfrow=c(4,4))
corrPlot(x="LC_CC",y="CH_CC",ktable)
corrPlot(x="LC_CC",y="LH_CC",ktable)
corrPlot(x="LC_CC",y="CH_LC",ktable)
...
# site comparisons
Rainbow_Emerald=load('../../../DESeq2/ofav/sym/Rainbow_Emerald_fc.RData')
Rainbow_Emerald # names of datasets in the package
fc.Rainbow_Emerald=kog.mwu(Rainbow_Emerald.fc,gene2kog) 
fc.Rainbow_Emerald 

Star_Emerald=load('../../../DESeq2/ofav/sym/Star_Emerald_fc.RData')
Star_Emerald # names of datasets in the package
fc.Star_Emerald=kog.mwu(Star_Emerald.fc,gene2kog) 
fc.Star_Emerald 

MacN_Emerald=load('../../../DESeq2/ofav/sym/MacN_Emerald_fc.RData')
MacN_Emerald # names of datasets in the package
fc.MacN_Emerald=kog.mwu(MacN_Emerald.fc,gene2kog) 
fc.MacN_Emerald 

Star_Rainbow=load('../../../DESeq2/ofav/sym/Star_Rainbow_fc.RData')
Star_Rainbow # names of datasets in the package
fc.Star_Rainbow=kog.mwu(Star_Rainbow.fc,gene2kog) 
fc.Star_Rainbow 

MacN_Rainbow=load('../../../DESeq2/ofav/sym/MacN_Rainbow_fc.RData')
MacN_Rainbow # names of datasets in the package
fc.MacN_Rainbow=kog.mwu(MacN_Rainbow.fc,gene2kog) 
fc.MacN_Rainbow 

MacN_Star=load('../../../DESeq2/ofav/sym/MacN_Star_fc.RData')
MacN_Star # names of datasets in the package
...
# Making a heatmap with hierarStarical clustering trees: 
pdf(file="KOG_urbanstress_ofav_sym_site_fc.pdf", width=7, height=7)
pheatmap(as.matrix(ktable),clustering_distance_cols="correlation",color=color, cellwidth=15, celMacNeight=15, border_color="white") 
while (!is.null(dev.list()))  dev.off()
...
# creating a pub-ready corr plot
pdf(file="KOG_urbanstress_ofav_sym_site_corr_fc.pdf", width=10, height=10)
par(mfrow=c(4,4))
corrPlot(x="Rainbow_Emerald",y="Star_Emerald",ktable)
corrPlot(x="Rainbow_Emerald",y="MacN_Emerald",ktable)
corrPlot(x="Rainbow_Emerald",y="Star_Rainbow",ktable)
...
# Making a heatmap with hierarchical clustering trees: 
pdf(file="KOG_urbanstress_ofav_sym_treatment_filtered_lpv.pdf", width=7, height=8)
pheatmap(as.matrix(ktable),clustering_distance_cols="correlation",color=color, cellwidth=15, cellheight=15, border_color="white") 
while (!is.null(dev.list()))  dev.off()
...
# creating a pub-ready corr plot
pdf(file="KOG_urbanstress_ofav_sym_treatment_filtered_corr_lpv.pdf", width=7, height=2.5)
par(mfrow=c(1,3))
corrPlot(x="LC_CC",y="CH_CC",ktable)
corrPlot(x="LC_CC",y="LH_CC",ktable)
corrPlot(x="CH_CC",y="LH_CC",ktable)
...
# Making a heatmap with hierarStarical clustering trees: 
pdf(file="KOG_urbanstress_ofav_sym_site_filtered_lpv.pdf", width=7, height=7)
pheatmap(as.matrix(ktable),clustering_distance_cols="correlation",color=color, cellwidth=15, celMacNeight=15, border_color="white") 
while (!is.null(dev.list()))  dev.off()
...
# creating a pub-ready corr plot
pdf(file="KOG_urbanstress_ofav_sym_site_filtered_corr_lpv.pdf", width=7, height=2.5)
par(mfrow=c(1,3))
corrPlot(x="Rainbow_Emerald",y="Star_Emerald",ktable)
corrPlot(x="Rainbow_Emerald",y="MacN_Emerald",ktable)
corrPlot(x="Star_Emerald",y="MacN_Emerald",ktable)
...
# Making a heatmap with hierarchical clustering trees: 
pdf(file="KOG_urbanstress_ofav_sym_treatment_filtered_fc.pdf", width=7, height=8)
pheatmap(as.matrix(ktable),clustering_distance_cols="correlation",color=color, cellwidth=15, cellheight=15, border_color="white") 
while (!is.null(dev.list()))  dev.off()
...
# creating a pub-ready corr plot
pdf(file="KOG_urbanstress_ofav_sym_treatment_filtered_corr_fc.pdf", width=7, height=2.5)
par(mfrow=c(1,3))
corrPlot(x="LC_CC",y="CH_CC",ktable)
corrPlot(x="LC_CC",y="LH_CC",ktable)
corrPlot(x="CH_CC",y="LH_CC",ktable)
...
# Making a heatmap with hierarStarical clustering trees: 
pdf(file="KOG_urbanstress_ofav_sym_site_filtered_fc.pdf", width=7, height=7)
pheatmap(as.matrix(ktable),clustering_distance_cols="correlation",color=color, cellwidth=15, celMacNeight=15, border_color="white") 
while (!is.null(dev.list()))  dev.off()
...
# creating a pub-ready corr plot
pdf(file="KOG_urbanstress_ofav_sym_site_filtered_corr_fc.pdf", width=7, height=2.5)
par(mfrow=c(1,3))
corrPlot(x="Rainbow_Emerald",y="Star_Emerald",ktable)
corrPlot(x="Rainbow_Emerald",y="MacN_Emerald",ktable)
corrPlot(x="Star_Emerald",y="MacN_Emerald",ktable)
