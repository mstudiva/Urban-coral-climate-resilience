...
lnames=load("../../../DESeq2/ofav/host/data4wgcna.RData")
...
load(file = "../../../DESeq2/ofav/host/data4wgcna.RData") # vsd table
...
library(WGCNA)
load(file = "networkdata_signed.RData")
load(file = "../../../DESeq2/ofav/host/data4wgcna.RData") 
load(file = "wgcnaData.RData");
allkME =as.data.frame(signedKME(datt, MEs))
gg=read.delim(file="../../../../Annotations/ofav/young/Ofaveolata_iso2geneName.tab",sep="\t")
library(pheatmap)
...
# pheatmap(hubs,scale="row",col=contrasting2,border_color=NA,treeheight_col=0,cex=0.9,cluster_rows=F,cluster_cols=F)
# dev.off()
pdf(file="heatmap top30 brown.pdf", height=6, width=18)
pheatmap(hubs,scale="row",col=contrasting2,border_color=NA,treeheight_col=0,cex=0.9,cluster_rows=F,cluster_cols=F)
dev.off()
