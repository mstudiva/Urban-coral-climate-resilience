...
lnames=load("../../../DESeq2/ssid/sym/data4wgcna.RData")
...
barplot(meanExpressionByArray,
        ...
        names.arg = c(1:70), cex.names = 0.7) # change names.arg dimensions to the size of your dataset
dev.off()
...
labeledHeatmap(Matrix = moduleTraitCor,
               ...
               cex.text = 0.7,
               zlim = c(-0.7,0.7),
               main = paste("Durusdinium Module-Trait correlations"))
...
mct[modLabels]
x=barplot(mct[rev(modLabels)],horiz=T,las=1,xlim=c(0,12000),col=rev(modLabels))
...
moduleCols=c("green","greenyellow","maroon","palevioletred3","coral2","pink","darkolivegreen") # for Emerald
# moduleCols=c("coral2") # for Star
# moduleCols=c("greenyellow","honeydew1","pink","sienna3") # for hightemp
# moduleCols=c("green","darkolivegreen") # for genotype
# moduleCols=c("green","pink") # for growthrate
# moduleCols=c("greenyellow","palevioletred3","honeydew1","pink") # for fvfm
# moduleCols=c("greenyellow","palevioletred3","honeydew1","pink") # for fvfm_ratio
# moduleCols=c("green","maroon","coral2","darkolivegreen") # for survival
# moduleCols=c("greenyellow","honeydew1","coral2","sienna3","indianred4") # for propB
# moduleCols=c("green","greenyellow","maroon","palevioletred3","honeydew1","coral2","pink","sienna3","darkolivegreen","indianred4") # for propD
# moduleCols=c("greenyellow","honeydew1","pink","sienna3") # for temp_actual
...
par(mfrow=c(2,4)) # for Emerald
# par(mfrow=c(1,1)) # for Star
# par(mfrow=c(1,4)) # for hightemp
# par(mfrow=c(1,2)) # for genotype
# par(mfrow=c(1,2)) # for growthrate
# par(mfrow=c(1,4)) # for fvfm
# par(mfrow=c(1,4)) # for fvfm_ratio
# par(mfrow=c(1,4)) # for survival
# par(mfrow=c(1,5)) # for propB
# par(mfrow=c(2,5)) # for propD
...
# which.module="honeydew1"
# which.module="coral2"
# which.module="pink"
# which.module="sienna3"
...
load(file = "../../../DESeq2/ssid/sym/data4wgcna.RData") # vsd table
...
library(WGCNA)
load(file = "networkdata_signed.RData")
load(file = "../../../DESeq2/ssid/sym/data4wgcna.RData") 
load(file = "wgcnaData.RData");
allkME =as.data.frame(signedKME(datt, MEs))
gg=read.delim(file="../../../../Annotations/symD/shoguchi/Durusdinium_iso2geneName.tab",sep="\t")
library(pheatmap)
...
# pdf(file="heatmap top30 green.pdf", height=6, width=39)
# pheatmap(hubs,scale="row",col=contrasting2,border_color=NA,treeheight_col=0,cex=0.9,cluster_rows=F,cluster_cols=F)
# dev.off()
# pdf(file="heatmap top30 greenyellow.pdf", height=6, width=39)
# pheatmap(hubs,scale="row",col=contrasting2,border_color=NA,treeheight_col=0,cex=0.9,cluster_rows=F,cluster_cols=F)
# dev.off()
# pdf(file="heatmap top30 maroon.pdf", height=6, width=30)
# pheatmap(hubs,scale="row",col=contrasting2,border_color=NA,treeheight_col=0,cex=0.9,cluster_rows=F,cluster_cols=F)
# dev.off()
# pdf(file="heatmap top30 palevioletred3.pdf", height=6, width=16)
# pheatmap(hubs,scale="row",col=contrasting2,border_color=NA,treeheight_col=0,cex=0.9,cluster_rows=F,cluster_cols=F)
# dev.off()
# pdf(file="heatmap top30 honeydew1.pdf", height=6, width=32)
# pheatmap(hubs,scale="row",col=contrasting2,border_color=NA,treeheight_col=0,cex=0.9,cluster_rows=F,cluster_cols=F)
# dev.off()
# pdf(file="heatmap top30 coral2.pdf", height=6, width=45)
# pheatmap(hubs,scale="row",col=contrasting2,border_color=NA,treeheight_col=0,cex=0.9,cluster_rows=F,cluster_cols=F)
# dev.off()
# pdf(file="heatmap top30 pink.pdf", height=6, width=20)
# pheatmap(hubs,scale="row",col=contrasting2,border_color=NA,treeheight_col=0,cex=0.9,cluster_rows=F,cluster_cols=F)
# dev.off()
# pdf(file="heatmap top30 sienna3.pdf", height=6, width=40)
# pheatmap(hubs,scale="row",col=contrasting2,border_color=NA,treeheight_col=0,cex=0.9,cluster_rows=F,cluster_cols=F)
# dev.off()
# pdf(file="heatmap top30 darkolivegreen.pdf", height=6, width=21)
# pheatmap(hubs,scale="row",col=contrasting2,border_color=NA,treeheight_col=0,cex=0.9,cluster_rows=F,cluster_cols=F)
# dev.off()
pdf(file="heatmap top30 indianred4.pdf", height=6, width=19)
pheatmap(hubs,scale="row",col=contrasting2,border_color=NA,treeheight_col=0,cex=0.9,cluster_rows=F,cluster_cols=F)
dev.off()
