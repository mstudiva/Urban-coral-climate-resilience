...
#read in counts
counts = read.table("../../../../raw/ssid/allcounts_host.txt")
...
pdf(file="heatmap_ssid_host.pdf", width=15, height=15)
pheatmap(cor(vsd))
dev.off()
...
pdf(file="PCoA_ssid_host.pdf", width=12, height=6)
par(mfrow=c(1,2))
plot(scores[,1], scores[,2],col=c("#018571","#80cdc1","#dfc27d","#a6611a")[as.numeric(as.factor(conditions$site))],pch=c(6,2,25,17)[as.numeric(as.factor(conditions$treat))], bg= c("#018571","#80cdc1","#dfc27d","#a6611a")[as.numeric(as.factor(conditions$site))], xlab="Coordinate 1 (12.5%)", ylab="Coordinate 2 (5.0%)", main="Site")
...
plot(scores[,1], scores[,2],col=c("#92c5de","#f4a582","#0571b0","#ca0020")[as.numeric(as.factor(conditions$treat))],pch=c(15,0,1,16)[as.numeric((as.factor(conditions$site)))], xlab="Coordinate 1 (12.5%)", ylab="Coordinate 2 (5.0%)", main="Treatment")
...
# p < 0.1
pdf(file="heatmap_treatment_p0.1.pdf", height=1.75, width=20)
