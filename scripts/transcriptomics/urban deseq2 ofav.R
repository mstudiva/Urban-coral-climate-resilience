...
ggsave("../../outputs/transcriptomics/ofav/deseq2/commongenes correlation treatment.pdf",
...
write.csv(treatment_filtered_genes,
          file = "../../outputs/transcriptomics/ofav/deseq2/commongenes correlation discordant treatment.csv")
...
print(panel_site)
ggsave("../../outputs/transcriptomics/ofav/deseq2/commongenes correlation site.pdf",
...
write.csv(site_filtered_genes,
          file = "../../outputs/transcriptomics/ofav/deseq2/commongenes correlation discordant site.csv")
