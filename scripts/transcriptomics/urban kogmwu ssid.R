...
gene2kog=read.table("../../../Siderastrea-siderea-annotated-transcriptome/Ssiderea_iso2kogClass.tab",sep="\t", fill=T)
head(gene2kog)


#### treatment all ####

LC_CC=load('../../outputs/transcriptomics/ssid/LC_CC_lpv.RData')
LC_CC # names of datasets in the package
lpv.LC_CC=kog.mwu(LC_CC.p,gene2kog) 
lpv.LC_CC 

CH_CC=load('../../outputs/transcriptomics/ssid/CH_CC_lpv.RData')
CH_CC # names of datasets in the package
lpv.CH_CC=kog.mwu(CH_CC.p,gene2kog) 
lpv.CH_CC

LH_CC=load('../../outputs/transcriptomics/ssid/LH_CC_lpv.RData')
LH_CC # names of datasets in the package
lpv.LH_CC=kog.mwu(LH_CC.p,gene2kog) 
lpv.LH_CC 

CH_LC=load('../../outputs/transcriptomics/ssid/CH_LC_lpv.RData')
CH_LC # names of datasets in the package
lpv.CH_LC=kog.mwu(CH_LC.p,gene2kog) 
lpv.CH_LC

LH_LC=load('../../outputs/transcriptomics/ssid/LH_LC_lpv.RData')
LH_LC # names of datasets in the package
lpv.LH_LC=kog.mwu(LH_LC.p,gene2kog) 
lpv.LH_LC

LH_CH=load('../../outputs/transcriptomics/ssid/LH_CH_lpv.RData')
...
pdf(file="../../outputs/transcriptomics/ssid/KOG_urbanstress_ssid_host_treatment_lpv.pdf", width=7, height=8)
...
pdf(file="../../outputs/transcriptomics/ssid/KOG_urbanstress_ssid_host_treatment_corr_lpv.pdf", width=10, height=10)
par(mfrow=c(4,4))
...
pdf(file="../../outputs/transcriptomics/ssid/KOG_urbanstress_ssid_host_site_lpv.pdf", width=7, height=7)
...
# creating a pub-ready corr plot
pdf(file="../../outputs/transcriptomics/ssid/KOG_urbanstress_ssid_host_site_corr_lpv.pdf", width=10, height=10)
par(mfrow=c(4,4))
...
# Making a heatmap with hierarchical clustering trees: 
pdf(file="../../outputs/transcriptomics/ssid/KOG_urbanstress_ssid_host_treatment_filtered_lpv.pdf", width=7, height=8)
pheatmap(as.matrix(ktable),clustering_distance_cols="correlation",color=color, cellwidth=15, cellheight=15, border_color="white") 
while (!is.null(dev.list()))  dev.off()
...
# creating a pub-ready corr plot
pdf(file="../../outputs/transcriptomics/ssid/KOG_urbanstress_ssid_host_treatment_filtered_corr_lpv.pdf", width=7, height=2.5)
par(mfrow=c(1,3))
corrPlot(x="LC_CC",y="CH_CC",ktable)
corrPlot(x="LC_CC",y="LH_CC",ktable)
corrPlot(x="CH_CC",y="LH_CC",ktable)
...
# Making a heatmap with hierarStarical clustering trees: 
pdf(file="../../outputs/transcriptomics/ssid/KOG_urbanstress_ssid_host_site_filtered_lpv.pdf", width=7, height=7)
pheatmap(as.matrix(ktable),clustering_distance_cols="correlation",color=color, cellwidth=15, celMacNeight=15, border_color="white") 
while (!is.null(dev.list()))  dev.off()
...
# creating a pub-ready corr plot
pdf(file="../../outputs/transcriptomics/ssid/KOG_urbanstress_ssid_host_site_filtered_corr_lpv.pdf", width=7, height=2.5)
par(mfrow=c(1,3))
corrPlot(x="Rainbow_Emerald",y="Star_Emerald",ktable)
corrPlot(x="Rainbow_Emerald",y="MacN_Emerald",ktable)
corrPlot(x="Star_Emerald",y="MacN_Emerald",ktable)
