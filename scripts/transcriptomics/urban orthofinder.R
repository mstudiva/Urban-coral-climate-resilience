...
load("../../outputs/transcriptomics/orthofinder/orthofinder_DEGs.RData") 
...
ofav_LC_CC_lpv <- read.csv(file = "../../outputs/transcriptomics/ofav/deseq2/LC_CC_lpv.csv") %>%
  select(gene, lpv) %>%
  rename("lpv_ofav" = lpv)

ofav_CH_CC_lpv <- read.csv(file = "../../outputs/transcriptomics/ofav/deseq2/CH_CC_lpv.csv") %>%
  select(gene, lpv) %>%
  rename("lpv_ofav" = lpv)

ofav_LH_CC_lpv <- read.csv(file = "../../outputs/transcriptomics/ofav/deseq2/LH_CC_lpv.csv") %>%
  select(gene, lpv) %>%
  rename("lpv_ofav" = lpv)

ofav_CH_LC_lpv <- read.csv(file = "../../outputs/transcriptomics/ofav/deseq2/CH_LC_lpv.csv") %>%
  select(gene, lpv) %>%
  rename("lpv_ofav" = lpv)

ofav_LH_CH_lpv <- read.csv(file = "../../outputs/transcriptomics/ofav/deseq2/LH_CH_lpv.csv") %>%
  select(gene, lpv) %>%
  rename("lpv_ofav" = lpv)

ofav_LH_LC_lpv <- read.csv(file = "../../outputs/transcriptomics/ofav/deseq2/LH_LC_lpv.csv") %>%
  select(gene, lpv) %>%
  rename("lpv_ofav" = lpv)

ssid_LC_CC_lpv <- read.csv(file = "../../outputs/transcriptomics/ssid/deseq2/LC_CC_lpv.csv") %>%
  select(gene, lpv) %>%
  rename("lpv_ssid" = lpv)

ssid_CH_CC_lpv <- read.csv(file = "../../outputs/transcriptomics/ssid/deseq2/CH_CC_lpv.csv") %>%
  select(gene, lpv) %>%
  rename("lpv_ssid" = lpv)

ssid_LH_CC_lpv <- read.csv(file = "../../outputs/transcriptomics/ssid/deseq2/LH_CC_lpv.csv") %>%
  select(gene, lpv) %>%
  rename("lpv_ssid" = lpv)

ssid_CH_LC_lpv <- read.csv(file = "../../outputs/transcriptomics/ssid/deseq2/CH_LC_lpv.csv") %>%
  select(gene, lpv) %>%
  rename("lpv_ssid" = lpv)

ssid_LH_CH_lpv <- read.csv(file = "../../outputs/transcriptomics/ssid/deseq2/LH_CH_lpv.csv") %>%
  select(gene, lpv) %>%
  rename("lpv_ssid" = lpv)

ssid_LH_LC_lpv <- read.csv(file = "../../outputs/transcriptomics/ssid/deseq2/LH_LC_lpv.csv") %>%
  select(gene, lpv) %>%
  rename("lpv_ssid" = lpv)


#### DESEQ IMPORT SITE ####
ofav_Rainbow_Emerald_lpv <- read.csv(file = "../../outputs/transcriptomics/ofav/deseq2/Rainbow_Emerald_lpv.csv") %>%
  select(gene, lpv) %>%
  rename("lpv_ofav" = lpv)

ofav_Star_Emerald_lpv <- read.csv(file = "../../outputs/transcriptomics/ofav/deseq2/Star_Emerald_lpv.csv") %>%
  select(gene, lpv) %>%
  rename("lpv_ofav" = lpv)

ofav_MacN_Emerald_lpv <- read.csv(file = "../../outputs/transcriptomics/ofav/deseq2/MacN_Emerald_lpv.csv") %>%
  select(gene, lpv) %>%
  rename("lpv_ofav" = lpv)

ofav_Star_Rainbow_lpv <- read.csv(file = "../../outputs/transcriptomics/ofav/deseq2/Star_Rainbow_lpv.csv") %>%
  select(gene, lpv) %>%
  rename("lpv_ofav" = lpv)

ofav_MacN_Rainbow_lpv <- read.csv(file = "../../outputs/transcriptomics/ofav/deseq2/MacN_Rainbow_lpv.csv") %>%
  select(gene, lpv) %>%
  rename("lpv_ofav" = lpv)

ofav_MacN_Star_lpv <- read.csv(file = "../../outputs/transcriptomics/ofav/deseq2/MacN_Star_lpv.csv") %>%
  select(gene, lpv) %>%
  rename("lpv_ofav" = lpv)

ssid_Rainbow_Emerald_lpv <- read.csv(file = "../../outputs/transcriptomics/ssid/deseq2/Rainbow_Emerald_lpv.csv") %>%
  select(gene, lpv) %>%
  rename("lpv_ssid" = lpv)

ssid_Star_Emerald_lpv <- read.csv(file = "../../outputs/transcriptomics/ssid/deseq2/Star_Emerald_lpv.csv") %>%
  select(gene, lpv) %>%
  rename("lpv_ssid" = lpv)

ssid_MacN_Emerald_lpv <- read.csv(file = "../../outputs/transcriptomics/ssid/deseq2/MacN_Emerald_lpv.csv") %>%
  select(gene, lpv) %>%
  rename("lpv_ssid" = lpv)

ssid_Star_Rainbow_lpv <- read.csv(file = "../../outputs/transcriptomics/ssid/deseq2/Star_Rainbow_lpv.csv") %>%
  select(gene, lpv) %>%
  rename("lpv_ssid" = lpv)

ssid_MacN_Rainbow_lpv <- read.csv(file = "../../outputs/transcriptomics/ssid/deseq2/MacN_Rainbow_lpv.csv") %>%
  select(gene, lpv) %>%
  rename("lpv_ssid" = lpv)

ssid_MacN_Star_lpv <- read.csv(file = "../../outputs/transcriptomics/ssid/deseq2/MacN_Star_lpv.csv") %>%
  select(gene, lpv) %>%
  rename("lpv_ssid" = lpv)
...
write.csv(orthofinder_treatment, file="../../outputs/transcriptomics/orthofinder/orthofinder_treatment.csv")
...
write.csv(orthofinder_site, file="../../outputs/transcriptomics/orthofinder/orthofinder_site.csv")


#### SAVING DATAFRAMES ####

# saving dataframes
save(orthologs, LC_CC, CH_CC, LH_CC, CH_LC, LH_CH, LH_LC, Rainbow_Emerald, Star_Emerald, MacN_Emerald, Star_Rainbow, MacN_Rainbow, MacN_Star, file = "../../outputs/transcriptomics/orthofinder/orthofinder_DEGs.RData")
...
sig_category3 <- function(lpv_ofav, lpv_ssid, levels_vec = SIG_LEVELS) {
  lv <- pmin(abs(lpv_ofav), abs(lpv_ssid))
  p  <- 10^(-lv)
  out <- dplyr::case_when(
    p <= 1e-6 ~ levels_vec[3],
    p <= 0.05 ~ levels_vec[2],
...
compute_global_limits <- function(comparisons, min_span = 0.6, pad_frac = 0.05) {
  vals <- unlist(lapply(comparisons, function(df) {
    d <- clean_lpv_df(df)
    d <- d[pmax(abs(d$lpv_ofav), abs(d$lpv_ssid)) >= 1.0, ]
...
make_panel <- function(df, title, global_lim) {
  dat <- clean_lpv_df(df)
  dat <- subset(dat, pmax(abs(dat$lpv_ofav), abs(dat$lpv_ssid)) >= 1.0)
  ...
  dat$sig_cat   <- sig_category3(dat$lpv_ofav, dat$lpv_ssid, levels_vec = SIG_LEVELS)
...
classify_for_filters <- function(df) {
  ...
  d$delta_log10p <- abs(d$abs_ofav - d$abs_ssid)
  d$p_ofav       <- 10^(-d$abs_ofav)
  d$p_ssid       <- 10^(-d$abs_ssid)
  d$p_ratio      <- pmax(d$p_ofav, d$p_ssid) / pmin(d$p_ofav, d$p_ssid)
  d
}
...
build_panels <- function(comparisons) {
  global_lim <- compute_global_limits(comparisons)
  panels <- mapply(
    FUN      = function(title, df) make_panel(df, title, global_lim),
...
filter_discordant <- function(comparisons, group_col) {
  filter_one <- function(df, group_name) {
  ...
  do.call(rbind, mapply(FUN = filter_one, group_name = names(comparisons),
                        df = comparisons, SIMPLIFY = FALSE))
}
...
panel_treatment <- build_panels(treatment_comparisons)
print(panel_treatment)
ggsave("../../outputs/transcriptomics/orthofinder/orthogroup correlation treatment.pdf",
       panel_treatment, width = 14, height = 9)
...
write.csv(treatment_filtered_genes,
          file = "../../outputs/transcriptomics/orthofinder/orthogroup correlation discordant treatment.csv")
...
panel_site <- build_panels(site_comparisons)
print(panel_site)
ggsave("../../outputs/transcriptomics/orthofinder/orthogroup correlation site.pdf",
       panel_site, width = 14, height = 9)
...
write.csv(site_filtered_genes,
          file = "../../outputs/transcriptomics/orthofinder/orthogroup correlation discordant site.csv")
...
load("../../outputs/transcriptomics/ofav/deseq2/realModels.RData"); dds_ofav <- dds
load("../../outputs/transcriptomics/ssid/deseq2/realModels.RData"); dds_ssid <- dds
