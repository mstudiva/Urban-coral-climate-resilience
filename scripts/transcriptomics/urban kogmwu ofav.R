...
pdf(file="../../outputs/transcriptomics/ofav/KOG_urbanstress_ofav_host_treatment_lpv.pdf", width=7, height=8)
...
pdf(file="../../outputs/transcriptomics/ofav/KOG_urbanstress_ofav_host_treatment_corr_lpv.pdf", width=10, height=10)
par(mfrow=c(4,4))
...
pdf(file="../../outputs/transcriptomics/ofav/KOG_urbanstress_ofav_host_site_lpv.pdf", width=7, height=7)
...
# creating a pub-ready corr plot
pdf(file="../../outputs/transcriptomics/ofav/KOG_urbanstress_ofav_host_site_corr_lpv.pdf", width=10, height=10)
par(mfrow=c(4,4))
...
# Making a heatmap with hierarchical clustering trees: 
pdf(file="../../outputs/transcriptomics/ofav/KOG_urbanstress_ofav_host_treatment_filtered_lpv.pdf", width=7, height=8)
pheatmap(as.matrix(ktable),clustering_distance_cols="correlation",color=color, cellwidth=15, cellheight=15, border_color="white") 
while (!is.null(dev.list()))  dev.off()
...
# creating a pub-ready corr plot
pdf(file="../../outputs/transcriptomics/ofav/KOG_urbanstress_ofav_host_treatment_filtered_corr_lpv.pdf", width=7, height=2.5)
par(mfrow=c(1,3))
corrPlot(x="LC_CC",y="CH_CC",ktable)
corrPlot(x="LC_CC",y="LH_CC",ktable)
corrPlot(x="CH_CC",y="LH_CC",ktable)
...
# Making a heatmap with hierarStarical clustering trees: 
pdf(file="../../outputs/transcriptomics/ofav/KOG_urbanstress_ofav_host_site_filtered_lpv.pdf", width=7, height=7)
pheatmap(as.matrix(ktable),clustering_distance_cols="correlation",color=color, cellwidth=15, celMacNeight=15, border_color="white") 
while (!is.null(dev.list()))  dev.off()
...
# creating a pub-ready corr plot
pdf(file="../../outputs/transcriptomics/ofav/KOG_urbanstress_ofav_host_site_filtered_corr_lpv.pdf", width=7, height=2.5)
par(mfrow=c(1,3))
corrPlot(x="Rainbow_Emerald",y="Star_Emerald",ktable)
corrPlot(x="Rainbow_Emerald",y="MacN_Emerald",ktable)
corrPlot(x="Star_Emerald",y="MacN_Emerald",ktable)
