...
urban <- read.csv("../../data/survivorship/urban survivorship.csv", head=T)
str(urban)
head(urban)
...
ggsave("../../outputs/survivorship/urban survivorship treatment nostats.pdf", urban_treatment_nostats_multiplot, width=10, height=8,dpi = 300)
...
ggsave("../../outputs/survivorship/urban survivorship treatment.pdf", urban_treatment_multiplot, width=10, height=10,dpi = 300)
...
ggsave("../../outputs/survivorship/urban survivorship ofav site.pdf", urban_ofav_site_multiplot, width=10, height=10,dpi = 300)
...
ggsave("../../outputs/survivorship/urban survivorship ssid site.pdf", urban_ssid_site_multiplot, width=10, height=10,dpi = 300)
...
ggsave("../../outputs/survivorship/urban survivorship ofav site type.pdf", urban_ofav_type_multiplot, width=10, height=10,dpi = 300)
...
ggsave("../../outputs/survivorship/urban survivorship ssid site type.pdf", urban_ssid_type_multiplot, width=10, height=10,dpi = 300)
