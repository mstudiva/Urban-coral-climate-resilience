...
capture.output(summary(anova_ofav), file = "../../outputs/growth/urban bw ofav anova.txt")

anova_ssid <- aov(growthadj ~ pH*site+site/genotype, data=bw_ssid)
summary(anova_ssid)
# site and pH significant
capture.output(summary(anova_ssid), file = "../../outputs/growth/urban bw ssid anova.txt")

# Tukey post hoc tests
# tukey <- TukeyHSD(anova)
# tukey$`species:site`
# capture.output(tukey$`species:site`, file = "../../outputs/growth/urban bw tukey.txt")

tukey_ofav <- TukeyHSD(anova_ofav)
tukey_ofav$`pH:site`
capture.output(tukey_ofav$`pH:site`, file = "../../outputs/growth/urban bw ofav tukey.txt")

tukey_ssid <- TukeyHSD(anova_ssid)
tukey_ssid$`pH:site`
capture.output(tukey_ssid$`pH:site`, file = "../../outputs/growth/urban bw ssid tukey.txt")
...
# plot
# 
# ggsave("../../outputs/growth/urban bw.pdf", plot, width=8, height=5,dpi = 300)
